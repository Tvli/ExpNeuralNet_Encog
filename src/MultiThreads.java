...
public class MultiThreads {
    ...
    public static BasicNetwork generateNetwork()
    {
        ...
        network.addLayer(new BasicLayer(MultiThreads.INPUT_COUNT));
        network.addLayer(new BasicLayer(MultiThreads.HIDDEN_COUNT));
        network.addLayer(new BasicLayer(MultiThreads.OUTPUT_COUNT));
